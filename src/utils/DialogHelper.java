...
public class DialogHelper {
    ...
    public static void alert(Component parent, String message) {
        JOptionPane.showMessageDialog(parent, message, "CLUB BILLIARDS", JOptionPane.INFORMATION_MESSAGE);
    }
    
    //
    public static void alertError(Component parent, String message){
        JOptionPane.showMessageDialog(parent, message, "CLUB BILLIARDS", JOptionPane.ERROR_MESSAGE);
    }
    ...
    public static boolean comfirm(Component parent, String message) {
        int result = JOptionPane.showConfirmDialog(parent, message, "CLUB BILLIARDS", JOptionPane.YES_NO_OPTION,
    ...
    public static String prompt(Component parent, String message){
        return JOptionPane.showInputDialog(parent, message, "CLUB BILLIARDS", JOptionPane.INFORMATION_MESSAGE);
    }
}
